...
CREATE TABLE IF NOT EXISTS `tpo`.`prijava` (
  ...
  `OCENA_IZPITA` INT(11) NULL DEFAULT '0',
...
VALUES
  ...
  (26, 63219,'Matematično modeliranje', 1),
  ...
  (55, 63277,'Programiranje 1', 1),
  (56, 63705,'Diskretne strukture', 1),
  (57, 63278,'Programiranje 2', 1),
  (58, 63209,'Računalniške komunikacije', 1),
  (59, 63279,'Algoritmi in Podatkovne Strukture 1', 1),
  (60, 63723,'Algoritmi in Podatkovne Strukture 2', 1),
  (61, 63709,'Opreacijski Sistemi', 1),
  (62, 63736,'Sistemska programska oprema', 1),


  (63, 63737,'Predmet iz multimedije', 1);
...
INSERT INTO `tpo`.`vpis`(`ID_VPIS`,`ID_PROGRAM`,`ID_NACIN`,`ID_STUD_LETO`,`ID_VRSTAVPISA`,
  ...
  (22,11,1,2,1,1,2,1,63150014),
  (23,4,1,3,1,1,2,1,63150000);
...
INSERT INTO tpo.rok
(ID_IZVEDBA, DATUM_ROKA, CAS_ROKA, AKTIVNOST)
VALUES
  (2,"2016-01-13", "10:00:00", 1),
  (39,"2016-01-25", "11:00:00", 1),
  (38,"2016-09-25", "12:00:00", 1),
  (37,"2016-01-13", "10:00:00", 1),
  (41,"2016-01-25", "11:00:00", 1),
  (45,"2016-09-25", "12:00:00", 1),
  (42,"2016-01-12", "12:00:00", 1),
  (43,"2016-01-12", "12:00:00", 1),
  (44,"2016-01-12", "12:00:00", 1),


  (24,"2018-01-13", "10:00:00", 1),
  (25,"2018-01-25", "11:00:00", 1),
  (26,"2018-09-25", "12:00:00", 1),
  (27,"2018-01-13", "10:00:00", 1),
  (28,"2018-01-25", "11:00:00", 1),
  (29,"2018-09-25", "12:00:00", 1),
  (30,"2018-01-12", "12:00:00", 1),
  (31,"2018-01-12", "12:00:00", 1),
  (32,"2018-01-12", "12:00:00", 1),
  (46,"2016-01-12", "12:00:00", 1),
  (40,"2016-01-12", "12:00:00", 1),
  (25,"2018-02-12", "12:00:00", 1),
  (25,"2018-03-11", "12:00:00", 1),
  (17,"2018-03-11", "12:00:00", 1);

INSERT INTO prijava( ID_ROK, VPISNA_STEVILKA, ZAP_ST_POLAGANJ, PODATKI_O_PLACILU, TOCKE_IZPITA, DATUM_PRIJAVE, DATUM_ODJAVE,ZAP_ST_POLAGANJ_LETOS, OCENA_IZPITA) VALUES
  (58, 63150014,1,1,55,'2018-01-02',NULL,1,6),
  (36, 63150014,1,1,99,'2018-01-04',NULL,1,10),
  (37, 63150014,1,2,88,'2018-01-05',NULL,1,9),
  (38, 63150014,1,1,57,'2018-01-03',NULL,1,6),
  (39, 63150014,1,1,70,'2018-01-04',NULL,1,8),
  (40,63150014,1,2,60,'2018-01-05',NULL ,1,8),
  (41,63150014,1,1,77,'2018-01-03',NULL ,1,8),
  (42,63150014,1,1,99,'2018-01-04',NULL ,1,10),
  (43,63150014,1,2,100,'2018-01-05',NULL,1,10),
  (44,63150014,1,1,100,'2018-01-03',NULL,1,10),
  (45,63150014,1,1,20,'2018-01-04',NULL ,1,5),
  (46,63150014,1,2,83,'2018-01-05',NULL ,1,9),
  (47,63150014,1,1,78,'2018-01-03',NULL ,1,8),
  (53,63150014,1,1,89,'2018-01-04',NULL ,1,9),
  (54,63150014,1,2,80,'2018-01-05',NULL ,1,9),
  (45,63150014,2,1,25,'2018-01-03',NULL ,2,5),
  (56,63150014,3,1,55,'2018-01-04',NULL ,1,6),
  (52,63150014,1,2,NULL,'2018-01-05',NULL,1,0),
  (45,63150014,1,2,100,'2018-07-05',NULL,3,10);
