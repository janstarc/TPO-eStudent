...
--
-- Odloži podatke za tabelo `izvedba_predmeta`
--
...
--
-- Odloži podatke za tabelo `kandidat`
--

INSERT INTO `kandidat` (`ID_KANDIDAT`, `ID_OSEBA`, `ID_PROGRAM`, `ID_STUD_LETO`, `IZKORISCEN`, `VPISNA_STEVILKA`, `EMSO`) VALUES
(1, 1, 3, 2, 1, 63150000, 2147483647),
(2, 4, 3, 2, 1, 63150001, 2147483647),
(3, 8, 1, 3, 0, 63182872, NULL);
...
--
-- Odloži podatke za tabelo `naslov`
--
...
CREATE TABLE `oseba` (
  ...
  `resetPwToken` varchar(40) COLLATE utf8_slovenian_ci DEFAULT NULL,
...
INSERT INTO `oseba` (`ID_OSEBA`, `IME`, `PRIIMEK`, `EMAIL`, `UPORABNISKO_IME`, `GESLO`, `VRSTA_VLOGE`, `TELEFONSKA_STEVILKA`, `resetPwToken`, `resetPwExpiration`, `resetPwUsed`) VALUES
(1, 'Janez', 'Novak', 'testS', 'testS', '123456', 's', '040040040', NULL, NULL, NULL),
(2, 'An', 'Ban', 'testP', 'testP', '123456', 'p', '030030030', NULL, NULL, NULL),
(3, 'Ancka', 'Novak', 'testR', 'testR', '123456', 'r', '050505050', NULL, NULL, NULL),
(4, 'Janezek', 'Novakovic', 'h437977@nwytg.com', 'testS2', '123456', 's', '123581321', NULL, NULL, NULL),
...
--
-- Odloži podatke za tabelo `stopnja`
--
...
(63182773, 7, NULL, NULL, '6599331539830', 8),
(63183863, 6, NULL, NULL, '7490218506879', 1);
...
CREATE TABLE `zeton` (
  ...
  `AKTIVNOST` int(11) DEFAULT '1',
  `ID_OBLIKA` int(11) NOT NULL,
  `ID_VRSTAVPISA` int(11) NOT NULL,
  `ID_NACIN` int(11) NOT NULL,
  `ID_PROGRAM` int(11) NOT NULL,
  `PROSTA_IZBIRNOST` varchar(45) COLLATE utf8_slovenian_ci DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_slovenian_ci;
...
INSERT INTO `zeton` (`ID_ZETON`, `ID_OSEBA`, `ID_LETNIK`, `ID_STUD_LETO`, `IZKORISCEN`, `AKTIVNOST`, `ID_OBLIKA`, `ID_VRSTAVPISA`, `ID_NACIN`, `ID_PROGRAM`, `PROSTA_IZBIRNOST`) VALUES
(3, 1, 1, 1, NULL, 1, 1, 1, 1, 1, '0'),
(4, 1, 2, 2, NULL, 1, 1, 1, 1, 1, '0'),
(5, 1, 3, 3, NULL, 1, 1, 1, 1, 1, '0'),
(7, 1, 3, 3, NULL, 1, 1, 1, 1, 1, '0'),
(8, 6, 1, 3, NULL, 1, 1, 1, 1, 1, '0'),
(9, 7, 1, 3, NULL, 1, 1, 1, 1, 8, '0');
...
--
-- Indeksi tabele `del_predmetnika`
--
...
--
-- Indeksi tabele `kandidat`
--
ALTER TABLE `kandidat`
  ADD PRIMARY KEY (`ID_KANDIDAT`),
  ADD KEY `FK_PROGRAM_idx` (`ID_PROGRAM`),
  ADD KEY `FK_STUD_LETO1` (`ID_STUD_LETO`),
  ADD KEY `FK_OSEBA11` (`ID_OSEBA`);
...
--
-- Indeksi tabele `predmeti_studenta`
--
...
ALTER TABLE `zeton`
  ...
  ADD KEY `fk_zeton_oblika_studija1_idx` (`ID_OBLIKA`),
  ADD KEY `fk_zeton_vrsta_vpisa1_idx` (`ID_VRSTAVPISA`),
  ADD KEY `fk_zeton_nacin_studija1_idx` (`ID_NACIN`),
  ADD KEY `fk_zeton_program1_idx` (`ID_PROGRAM`);
...
--
-- AUTO_INCREMENT tabele `predmeti_studenta`
--
ALTER TABLE `predmeti_studenta`
  MODIFY `ID_PREDMETISTUDENTA` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT tabele `predmetnik`
--
ALTER TABLE `predmetnik`
...
--
ALTER TABLE `kandidat`
  ADD CONSTRAINT `FK_OSEBA11` FOREIGN KEY (`ID_OSEBA`) REFERENCES `oseba` (`ID_OSEBA`),
  ADD CONSTRAINT `FK_PROGRAM_2` FOREIGN KEY (`ID_PROGRAM`) REFERENCES `program` (`ID_PROGRAM`),
  ADD CONSTRAINT `FK_STUD_LETO1` FOREIGN KEY (`ID_STUD_LETO`) REFERENCES `studijsko_leto` (`ID_STUD_LETO`);

--
-- Omejitve za tabelo `naslov`
--
ALTER TABLE `naslov`
...
--
-- Omejitve za tabelo `predmeti_studenta`
--
ALTER TABLE `predmeti_studenta`
...
ALTER TABLE `zeton`
  ...
  ADD CONSTRAINT `fk_zeton_nacin_studija1` FOREIGN KEY (`ID_NACIN`) REFERENCES `nacin_studija` (`ID_NACIN`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_zeton_oblika_studija1` FOREIGN KEY (`ID_OBLIKA`) REFERENCES `oblika_studija` (`ID_OBLIKA`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_zeton_program1` FOREIGN KEY (`ID_PROGRAM`) REFERENCES `program` (`ID_PROGRAM`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_zeton_vrsta_vpisa1` FOREIGN KEY (`ID_VRSTAVPISA`) REFERENCES `vrsta_vpisa` (`ID_VRSTAVPISA`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
