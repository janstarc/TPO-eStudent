...
CREATE TABLE IF NOT EXISTS `tpo`.`prijava` (
  ...
  `DATUM_PRIJAVE` DATE NULL DEFAULT NULL,
  `ID_OSEBA_PRIJAVITELJ` INT(11) NULL,
  `DATUM_ODJAVE` DATE NULL DEFAULT NULL,
  `ID_OSEBA_ODJAVITELJ` INT(11) NULL,
...
INSERT INTO prijava(ID_PRIJAVA, ID_ROK, VPISNA_STEVILKA, ZAP_ST_POLAGANJ, ZAP_ST_POLAGANJ_LETOS, PODATKI_O_PLACILU, TOCKE_IZPITA, DATUM_PRIJAVE, DATUM_ODJAVE) VALUES
                    ...
                    (4,2,63150000,1,1,1,NULL,'2018-01-03',NULL),
                    (5,3,63150001,2,2,1,NULL,'2018-06-01',NULL),
                    (6,3,63150002,2,2,1,NULL,'2018-06-02',NULL),
