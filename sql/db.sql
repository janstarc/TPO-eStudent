...
CREATE TABLE IF NOT EXISTS `tpo`.`zeton` (
  ...
  `ID_NACIN` INT(11) NOT NULL,
  `ID_PROGRAM` INT(11) NOT NULL,
  `PROSTA_IZBIRNOST` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_slovenian_ci' NULL DEFAULT '0',
...
(`ID_OSEBA`, `ID_LETNIK`, `ID_STUD_LETO`, `ID_OBLIKA`, `ID_NACIN`, `ID_VRSTAVPISA`, `ID_PROGRAM`,`IZKORISCEN`)
