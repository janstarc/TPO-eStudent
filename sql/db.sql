...
VALUES
  ...
  (1,5,"2018-01-13", "10:00:00", 1),
  (2,5,"2018-01-25", "11:00:00", 1),
  (3,5,"2018-09-25", "12:00:00", 1),

  /* P1 (Mah), Studijsko leto 2017/18 */
  (4,6,"2018-01-12", "12:00:00", 1),
  (5,6,"2018-01-19", "13:00:00", 1),
  (6,6,"2018-09-21", "14:00:00", 1),

  /* TPO (Mah, Fur, Poz), Studijsko leto 2016/17 */
  (7,1,"2017-06-20", "14:00:00", 1),
  (8,1,"2017-06-25", "15:00:00", 1),
  (9,1,"2017-09-05", "16:00:00", 1),

  /* P1 (Fur, Poz), Studijsko leto 2016/17 */
  (10,2,"2017-01-20", "16:00:00", 1),
  (11,2,"2017-01-25", "17:00:00", 1),
  (12,2,"2017-09-05", "18:00:00", 1),

  /*id_predmet=9, stud_leto=2017/18*/
  (13,21,"2019-01-20", "16:00:00", 1),
  (14,21,"2019-01-25", "17:00:00", 1),
  (15,21,"2018-09-05", "18:00:00", 1),

  /*id_predmet=12, stud_leto=2017/18*/
  (16,22,"2019-01-21", "16:00:00", 1),
  (17,22,"2019-01-26", "17:00:00", 1),
  (18,22,"2018-09-06", "18:00:00", 1);
...
INSERT INTO prijava(ID_PRIJAVA, ID_ROK, VPISNA_STEVILKA, ZAP_ST_POLAGANJ, ZAP_ST_POLAGANJ_LETOS, PODATKI_O_PLACILU, TOCKE_IZPITA, DATUM_PRIJAVE, DATUM_ODJAVE) VALUES
                    (1,1,63150000,1,1,1,NULL,'2018-01-02',NULL),
                    (2,1,63150001,1,1,1,NULL,'2018-01-04',NULL),
                    (3,1,63150002,1,1,2,NULL,'2018-01-05',NULL),
                    (4,2,63150000,2,2,1,NULL,'2018-01-03',NULL),
                    (5,2,63150001,2,2,1,NULL,'2018-06-01',NULL),
                    (7,3,63150003,2,2,1,NULL,'2018-06-03',NULL);
