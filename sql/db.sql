...
-- -----------------------------------------------------
-- Table `tpo`.`student`
-- TODO!!! --> Set NOT NULL for ID_KANDIDAT, ID_VPIS and ID_PROGRAM
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `tpo`.`student` (
  ...
  `ID_KANDIDAT` INT(11) NULL,
  `ID_VPIS` INT(11) NULL,
  `EMSO` CHAR(20) CHARACTER SET 'utf8' COLLATE 'utf8_slovenian_ci' NULL,
  `ID_PROGRAM` INT(11) NULL DEFAULT NULL,
