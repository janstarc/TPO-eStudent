    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <form action="<?= BASE_URL . $formAction . "/" . $id ?>" method="post" class="form-horizontal">
                <div class="row">
                    <div class="col-xs-12 col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Priimek" name="Priimek" value="<?= $KandidatPodatki["priimek"] ?>" disabled required >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="emso" name="emso" value="<?= $KandidatPodatki["emso"] ?>" disabled required>
                        </div>
                        <div class="form-group">
                            <label for="telefonska_stevilka">Telefon</label>
                            <input type="number" class="form-control" id="telefonska_stevilka" name="telefonska_stevilka" value="<?= $KandidatPodatki["telefonska_stevilka"] ?>" disabled required>
                        </div>
                        <div class="form-group">
                            <label for="id_drzava">Državljanstvo</label>
                            <select class="form-control" id="id_drzava" name="id_drzava" disabled required>
                    ...
                    <div class="col-xs-12 col-md-4">
                        ...
                        foreach ($naslove as $naslov): ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="ulica<?= $i ?>" name="ulica<?= $i ?>" value="<?= $naslov["ULICA"] ?>" disabled required>
                            </div>
                            <div class="form-group">
                                <label for="hisna_stevilka<?= $i ?>">Hišna številka</label>
                                <input type="number" class="form-control" id="hisna_stevilka<?= $i ?>" name="hisna_stevilka<?= $i ?>" value="<?= $naslov["HISNA_STEVILKA"] ?>" disabled required>
                            </div>
                            <div class="form-group">
                                <label for="id_posta<?= $i ?>">Kraj in poštna številka</label>
                                <select class="form-control" id="id_posta<?= $i ?>" name="id_posta<?= $i ?>" disabled required>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6 offset-md-3">
                        <button id="btn" class="btn btn-theme btn-block" type="submit">Izpiši 1 potrdilo o vpisu</button>
