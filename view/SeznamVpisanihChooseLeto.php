...
<section id="container">
    <?php
        ...
        elseif(User::isLoggedInAsStudentOfficer()) include("view/includes/menu-links-student-officer.php");
                    ...
                    <div class="form-group">
                        <select class="form-control" name="ID_STUD_LETO" onchange="location = this.value;">
                            ...
                            <?php foreach ($allData as $data): ?>
                                <option value="<?= "vpisaniStudenti/" . $data["ID_STUD_LETO"] ?>"><?= $data["STUD_LETO"] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
