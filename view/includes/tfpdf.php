...
class tFPDF
{
    ...
    function BasicTable3($header,$lineData,$header1,$naslov)
    {
        ...
        for($i=count($header1);$i<count($header);$i++){
            $this->Cell(50, 7, $header[$i], 0);
            $this->Cell(50, 7, $lineData[$i], 0);
            $this->Ln();
        }
    ...
    function BasicTableHKT($header,$lineData){
        $c = 0;
        $this->Cell(8, 7, "#", 1);
        foreach($header as $col) {
            $size = 25;
    ...
    function BasicTableHSt2($header,$lineData){
        $c=-1;
        $this->Cell(10, 7, "#", 1);
        foreach($header as $col) {
            $c+=1;
    ...
    }function BasicTableH3($header,$lineData){
